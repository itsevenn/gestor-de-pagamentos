  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl max-h-[85vh] overflow-hidden">
        <DialogHeader className="px-4 py-3 bg-gradient-to-r from-slate-50 to-blue-50 dark:from-slate-700 dark:to-slate-600 border-b border-slate-200 dark:border-slate-600">
        ...
        <div className="flex flex-col gap-3 p-4">
          {/* Controles */}
          <div className="flex flex-wrap items-center gap-3 p-3 bg-slate-50 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-600">
          ...
          {/* Área de Corte */}
          <div className="flex justify-center bg-slate-100 dark:bg-slate-900 rounded-xl p-4 min-h-[300px] border border-slate-200 dark:border-slate-700">
            {imageSrc ? (
              <ReactCrop
                crop={crop}
              ...
              <div className="flex items-center justify-center text-slate-500 dark:text-slate-400">
                <div className="text-center">
                  <div className="w-12 h-12 border-4 border-slate-300 dark:border-slate-600 border-t-blue-500 rounded-full animate-spin mx-auto mb-3"></div>
                  <p className="text-base font-medium">Carregando imagem...</p>
                </div>
              </div>
            )}
          </div>
          ...
          {/* Instruções */}
          <div className="text-sm text-slate-600 dark:text-slate-400 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 p-3 rounded-xl border border-blue-200 dark:border-blue-800">
        ...
        <DialogFooter className="flex gap-3 p-4 border-t border-slate-200 dark:border-slate-700">
          <Button
            variant="outline"
            onClick={onClose}
